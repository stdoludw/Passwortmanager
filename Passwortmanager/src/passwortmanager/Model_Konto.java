...
public class Model_Konto {
    ...
    public Model_Konto(String mstrDienst, String mstrUsername, String mstrantworta, String mstrantwortb, String mstremail, String mstrerstellt, String mstrfragea, String mstrfrageb, String mstrgeanertam, String mstrkontakt, String mstrpasswort, String mstrresetemail, String mstrreseturl, String mstrwebseite) {
    ...
    tmp.add(mstrDienst); 
             tmp.add(mstrwebseite);
       tmp.add( mstrreseturl);
      tmp.add( mstrkontakt);
             tmp.add(mstrUsername);
       tmp.add( mstrpasswort);
        tmp.add(mstrresetemail);
       tmp.add(mstremail);
         tmp.add(mstrerstellt);
        tmp.add(mstrgeanertam);
       tmp.add(mstrantworta);
       tmp.add(mstrantwortb);
       tmp.add( mstrfragea);
        tmp.add(mstrfrageb);
                 tmp.add("0");
